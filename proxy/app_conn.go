...
type AppConnSnapshot interface {
	...
	GetSnapshotChunkSync(types.RequestGetSnapshotChunk) (*types.ResponseGetSnapshotChunk, error)
...
func (app *appConnSnapshot) GetSnapshotChunkSync(
	req types.RequestGetSnapshotChunk) (*types.ResponseGetSnapshotChunk, error) {
	return app.appConn.GetSnapshotChunkSync(req)
}
